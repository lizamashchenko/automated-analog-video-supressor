...
# Grid-search classifier thresholds against a dataset run

# options:
#   -h, --help            show this help message and exit
#   --run-prefix PREFIX   Run prefix (e.g. dataset_cyclo_20260419_132451)
#   --classifier {cyclo,autocorr,harmonic}
#                         Classifier to tune
#   --metadata PATH       Metadata CSV path
#   --logs-base DIR       Base logs directory (default: logs)
#   --exclude-freqs SPEC  Comma-separated MHz freqs/ranges to exclude from FP count (e.g. '762,1100-1300,2400-2500,3200-3300')
#   --exclude-sweeps SPEC
#                         Exclude all FPs from sweeps matching metadata conditions. Format: 'key=val,key=val' (AND); groups separated by ';'
#                         (OR). E.g. 'drone_freq=1240,distance _m=1.5'
#   --top N               Show top N configs (default 15)
...
def main():
    parser = argparse.ArgumentParser(
        description="Grid-search classifier thresholds against a dataset run",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    parser.add_argument("--run-prefix", required=True, metavar="PREFIX",
                        help="Run prefix (e.g. dataset_cyclo_20260419_132451)")
    ...
    parser.add_argument("--exclude-sweeps", metavar="SPEC", default=None,
    ...
    parser.add_argument("--top", type=int, default=15, metavar="N",
                        help="Show top N configs (default 15)")
